...
- Deployment and post-deployment verification pending. A conservative web CPU limit increase from 0.75 to 1 core is planned, preserving the existing 0.25 CPU reservation, 1 GB memory limit, and 512 MB memory reservation.
